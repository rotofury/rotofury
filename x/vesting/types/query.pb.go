...
// source: gridiron/vesting/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryAirdropsRequest)(nil), "gridiron.vesting.v1.QueryAirdropsRequest")
	proto.RegisterType((*QueryAirdropsResponse)(nil), "gridiron.vesting.v1.QueryAirdropsResponse")
	proto.RegisterType((*QueryAirdropRequest)(nil), "gridiron.vesting.v1.QueryAirdropRequest")
	proto.RegisterType((*QueryAirdropResponse)(nil), "gridiron.vesting.v1.QueryAirdropResponse")
	proto.RegisterType((*QueryParamsRequest)(nil), "gridiron.vesting.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "gridiron.vesting.v1.QueryParamsResponse")
}

func init() { proto.RegisterFile("gridiron/vesting/v1/query.proto", fileDescriptor_fed7c8be0346c387) }
...
func (c *queryClient) Airdrops(ctx context.Context, in *QueryAirdropsRequest, opts ...grpc.CallOption) (*QueryAirdropsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gridiron.vesting.v1.Query/Airdrops", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Airdrop(ctx context.Context, in *QueryAirdropRequest, opts ...grpc.CallOption) (*QueryAirdropResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gridiron.vesting.v1.Query/Airdrop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gridiron.vesting.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Airdrops_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gridiron.vesting.v1.Query/Airdrops",
	}
...
func _Query_Airdrop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gridiron.vesting.v1.Query/Airdrop",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gridiron.vesting.v1.Query/Params",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gridiron.vesting.v1.Query",
	...
	Metadata: "gridiron/vesting/v1/query.proto",
}
