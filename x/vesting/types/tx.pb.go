...
// source: gridiron/vesting/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgAddAirdrops)(nil), "gridiron.vesting.v1.MsgAddAirdrops")
	proto.RegisterType((*MsgAddAirdropsResponse)(nil), "gridiron.vesting.v1.MsgAddAirdropsResponse")
	proto.RegisterType((*MsgExecuteAirdrops)(nil), "gridiron.vesting.v1.MsgExecuteAirdrops")
	proto.RegisterType((*MsgExecuteAirdropsResponse)(nil), "gridiron.vesting.v1.MsgExecuteAirdropsResponse")
	proto.RegisterType((*MsgSetAllocationAddress)(nil), "gridiron.vesting.v1.MsgSetAllocationAddress")
	proto.RegisterType((*MsgSetAllocationAddressResponse)(nil), "gridiron.vesting.v1.MsgSetAllocationAddressResponse")
}

func init() { proto.RegisterFile("gridiron/vesting/v1/tx.proto", fileDescriptor_7ff1dd0df923de90) }
...
func (c *msgClient) AddAirdrops(ctx context.Context, in *MsgAddAirdrops, opts ...grpc.CallOption) (*MsgAddAirdropsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gridiron.vesting.v1.Msg/AddAirdrops", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ExecuteAirdrops(ctx context.Context, in *MsgExecuteAirdrops, opts ...grpc.CallOption) (*MsgExecuteAirdropsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gridiron.vesting.v1.Msg/ExecuteAirdrops", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SetAllocationAddress(ctx context.Context, in *MsgSetAllocationAddress, opts ...grpc.CallOption) (*MsgSetAllocationAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gridiron.vesting.v1.Msg/SetAllocationAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddAirdrops_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gridiron.vesting.v1.Msg/AddAirdrops",
	}
...
func _Msg_ExecuteAirdrops_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gridiron.vesting.v1.Msg/ExecuteAirdrops",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SetAllocationAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gridiron.vesting.v1.Msg/SetAllocationAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gridiron.vesting.v1.Msg",
	...
	Metadata: "gridiron/vesting/v1/tx.proto",
}
