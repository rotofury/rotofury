...
// source: gridiron/vesting/v1/vesting.proto
...
func init() {
	proto.RegisterType((*Airdrop)(nil), "gridiron.vesting.v1.Airdrop")
}

func init() { proto.RegisterFile("gridiron/vesting/v1/vesting.proto", fileDescriptor_9e59ec182944cd7f) }
